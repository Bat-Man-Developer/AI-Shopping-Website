          ...
          <div class="dashboardinfo">
            <div class="adminorderstablecontainer">
              <table class="adminorderstable">
                ...
                <tbody>
                  <?php include('sellersserver/getsellersorders.php');
                  ...
                  <tr>
                    ...
                    <td id="btn"><a class="btn btn-primary" href="sellersvieworders.php?fldorderid=<?php echo $order['fldorderid']; ?>&fldproductsellersid=<?php echo $_SESSION['fldproductsellersid']; ?>">View Order</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
