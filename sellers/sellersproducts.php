          ...
          <div class="dashboardinfo">
            <div class="adminproductstablecontainer">
              <table class="adminproductstable">
                ...
                <tbody>
                  <?php include('sellersserver/getsellersproducts.php');
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-primary" href="<?php echo "sellerseditimages.php?fldproductid=".$product['fldproductid']."&fldproductname=".$product['fldproductname'];?>">Edit Images</a></td>

                    <td><a class="btn btn-primary" href="sellerseditproducts.php?fldproductid=<?php echo $product['fldproductid']; ?>">Edit</a></td>
                    <td><a class="btn btn-danger" href="sellersdeleteproducts.php?fldproductid=<?php echo $product['fldproductid']; ?>">Delete</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
