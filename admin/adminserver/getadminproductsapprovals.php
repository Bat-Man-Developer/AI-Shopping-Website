<?php
  ...
  //2. return number of products approvals
  $stmt = $conn->prepare("SELECT COUNT(*) AS fldtotalrecords FROM productsapprovals");
  $stmt->execute();
  ...
  //4. get all products approvals
  $stmt1 = $conn->prepare("SELECT * FROM productsapprovals LIMIT $offset,$totalrecordsperpage");
  $stmt1->execute();
