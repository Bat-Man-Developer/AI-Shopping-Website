...
<!DOCTYPE html>
	<html lang="en">
	  ...
	  <div class="header">
		...
		<!--------- Testimonials-page ------------>
    <section class="testimonials mt-5 py-5">
			<div class="container mt-5">
        <h2 class="font-weight-bold">Testimonials & Suggestions...</h2>
				<hr class="mx-auto">
      </div>
			<!--------- Website Message ------------>
    ...
    <div class="row">
      <form id="testimonialsform" method="POST" action="testimonials.php">
        ...
        <div class="form-group">
          <button type="submit" name="testimonialscommentbtn" id="testimonialscommentbtn" class="btn" required>Submit Comment..</button>
        </div>
      </form>
    </div>
<?php
